(function () {
    ...
    angular.module("ListaTelefonica").controller("listPicMeController", ['picMeAPI', 'mobileNgMsg', 'config', '$rootScope', '$scope', '$window', listPicMeController])

    function listPicMeController(picMeAPI, mobileNgMsg, config, $rootScope, $scope, $window) { 
