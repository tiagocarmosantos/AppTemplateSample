(function () {
    ...
    angular.module("ListaTelefonica").controller("listPicMeController", ['picMeAPI', 'mobileNgMsg', '$rootScope', '$scope', '$window', listPicMeController])

    function listPicMeController(picMeAPI, mobileNgMsg, $rootScope, $scope, $window) { 
