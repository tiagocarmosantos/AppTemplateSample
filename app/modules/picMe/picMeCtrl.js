(function () {
    ...
    angular.module("AppTemplate").controller("picMeController", ['picMeAPI', 'mobileNgMsg', '$rootScope', '$scope', '$window', picMeController])

    function picMeController(picMeAPI, mobileNgMsg, $rootScope, $scope, $window) { 
        ...
        vm.qrCodePicMe = () => {
          ...
          var routeNewPicMeAnonymousUser = `${$rootScope.config.appHome.getAppHome()}${vm.routeNewPicMe}&name=Anonymous`
        ...
        vm.sharePicMe = (picMe) => {
            ...
            .then(blob => {
                ...
                let shareData = {
                    text: `${$rootScope.config.appName} - ${$rootScope.config.user.Name}`,
                    title: picMe.image.title,
                    files: [file],
                    url: $rootScope.config.appHome.getAppHome()
                }
