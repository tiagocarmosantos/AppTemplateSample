...
(function () {
    ...
    function listPicMeController(picMeAPI, $rootScope, $scope, $window, $location, $timeout) {
        ...
        vm.listPicMe = function () {
            picMeAPI.getPicsMe('user.email', $rootScope.User.Email).then(function (data) {
...
(function () {
	...
	function picMeAPI($http, config) {
		...
		var _getPicsMe = function _getPicsMe(filterParam, filterValue) {
		...
		var _deletePicMe = function _deletePicMe(id) {
			return $http.delete(config.oapiUrl + "/picMe/" + id).then(function (response) {
				return JSON.parse(JSON.stringify(response.data));
			}).catch(function (error) {
...
(function () {
	...
	var _angular$module$const;

	angular.module("ListaTelefonica").constant("config", (_angular$module$const = {
	...
	}, _defineProperty(_angular$module$const, "apiUrl", 'https://microservice-sample.herokuapp.com/oapi'), _defineProperty(_angular$module$const, "userKey", '_lista_telefonica_app_user'), _angular$module$const)).run(['$rootScope', 'config', function ($rootScope, config) {
		$rootScope.config = config;
		$rootScope.showHeader = true;
		$rootScope.showFooter = true;
		$rootScope.User = { ID: null, Name: null, ImageURL: null, Email: null, idToken: null, Logado: false, onSignIn: function onSignIn() {}, onSignOut: function onSignOut() {} };
	}]);
})();
'use strict';
