    ...
    function listPicMeController(picMeAPI, mobileNgMsg, $rootScope, $scope, $window) {
        ...
        vm.sharePicMe = function (picMe) {
            ...
            fetch(picMe.image.content).then(function (response) {
                ...
                var file = new File([arrayBuffer], picMe.image.title, { type: picMe.image.contentType });
...
(function () {
		...
		function picMeAPI(config) {
				...
				var _getPicsMe = function _getPicsMe(filter) {
						var url = !!filter ? config.oapiUrl + "/picMe/?filter=" + filter.param + ":" + filter.value : config.oapiUrl + "/picMe";
				...
				var _getPicMe = function _getPicMe(id) {
						return fetch(config.oapiUrl + "/picMe/" + id).then(function (response) {
								return response.json();
						}).then(function (data) {
								return data;
						}).catch(function (error) {
				...
				var _deletePicMe = function _deletePicMe(id) {
						return fetch(config.oapiUrl + "/picMe/" + id, { method: 'DELETE' }).then(function (response) {
								return response.json();
						}).then(function (data) {
								return data;
						}).catch(function (error) {
...
(function () {
	...
	function quickMenuAPI($http, config) {
		...
		var _deleteQuickMenu = function _deleteQuickMenu(id) {
			return $http.delete(config.oapiUrl + "/quickMenu/" + id).then(function (response) {
				return JSON.parse(JSON.stringify(response.data));
			}).catch(function (error) {
